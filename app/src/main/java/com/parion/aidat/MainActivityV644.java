...
/** v4.0.44 - semantic dashboard grouping; deleted athletes removed from dashboard. */
public class MainActivityV644 extends MainActivityV643 {
    @Override void showHome(){
        super.showHome();
        if(root!=null){
            root.postDelayed(this::organize644,700);
            root.postDelayed(this::organize644,1250);
        }
    }
    ...
    private void organize644(){
        ...
        // Dashboard is operational only: archive/deleted athletes belong in Settings.
        removeTopContaining644(box,"SİLİNEN SPORCULAR");
        ...
        // Remove obsolete section headings before rebuilding the information hierarchy.
    ...
    private void removeTopContaining644(LinearLayout box,String needle){TextView t=findText644(box,needle);if(t==null)return;View top=top644(box,t);if(top!=null)box.removeView(top);}
