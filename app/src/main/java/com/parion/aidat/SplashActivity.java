...
public class SplashActivity extends Activity {
    @Override public void onCreate(Bundle b){
        ...
        ImageView logo=new ImageView(this);logo.setImageResource(R.drawable.parion_official_logo);logo.setScaleType(ImageView.ScaleType.CENTER_INSIDE);root.addView(logo,new LinearLayout.LayoutParams(dp(170),dp(170)));
        ...
        setContentView(root);
        root.postDelayed(()->{startActivity(new Intent(this,MainActivityV679.class));finish();},320);
    }
