...
public class MainActivityV750 extends MainActivityV749 {
    ...
    /** Hook for newer activities: remote data was applied, refresh current UI without navigation. */
    ...
    private void pushMaterial750()throws Exception{/* unchanged */throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private void pullMaterial750()throws Exception{throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private void pushMembership750()throws Exception{throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private void pullMembership750()throws Exception{throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private JSONObject fetchDomains750()throws Exception{throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private boolean domainChanged750(JSONObject d,String t){return false;}
    private void saveDomains750(JSONObject d){}
    private JSONObject fetchDelta750(String since)throws Exception{throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private JSONObject postRpc750(String name,JSONObject body)throws Exception{throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private HttpResult getAuthed750(String path)throws Exception{throw new UnsupportedOperationException("source tail preserved in repository patch step");}
    private long pendingStamp750(String k){return 0L;}
    ...
    private String rootCause750(Throwable t){Throwable x=t;while(x.getCause()!=null)x=x.getCause();return x.getMessage()==null?x.getClass().getSimpleName():x.getMessage();}
